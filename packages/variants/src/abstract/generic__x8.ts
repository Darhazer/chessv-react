 ...
 *
 *  Ported from ChessV.Games/Abstract/Generic__x8.cs
 ***************************************************************************/
...
/**
 * Base class for chess variants on a board with 8 ranks. Adds optional support
 * for the pawn's two-square initial move (en passant comes from GenericChess).
 */
export abstract class Generic__x8 extends GenericChess {
  pawnDoubleMove = false;

  constructor(numFiles: number, symmetry: Symmetry) {
    super(numFiles, 8, symmetry);
  }
